...
fun main(args: Array<String>) {
    println("AOC 2021, Day 11.2 starting!!!!")
    ...
    for(step in 1 .. 800) {
        ...
        if(squidSquad.isSynchronized()) {
            println("Squid Squad synchronized on step $step")
            break
        }
    }
    ...
    println("AOC 2021, Day 11.2 complete!!!!")
}
