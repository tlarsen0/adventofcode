...
fun main(args: Array<String>) {
    println("AOC 2022, Day 5, Part 2 starting!!!")
...
data class CrateStacks constructor (val stackCount:Int) {
    ...
    fun move(moveCrates: Int, from: Int, to: Int) {
        ...
        for(move in 1 .. moveCrates) {
            ...
            specialStack.addFirst(theCrate)
        }
        while(specialStack.isNotEmpty()) {
            val theCrate = specialStack.removeFirst()
